...
Skybox::Skybox(const char* texPath, const char* fragPath, const char* vertPath)
	:m_Texture(texPath, GL_TEXTURE0, GL_TEXTURE_CUBE_MAP, true), m_Shader(fragPath, vertPath)
{
